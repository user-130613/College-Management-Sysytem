...
from . import hod_views, staff_views, student_views, views,admin_views
...
urlpatterns = [
    ...
    path("hod/add", admin_views.add_hod, name='add_hod'),
    ...
    path("admin_notify_staff", admin_views.admin_notify_staff,name='admin_notify_staff'),
    ...
    path("session/edit/<int:session_id>",admin_views.edit_session, name='edit_session'),
    path("student/view/feedback/", admin_views.student_feedback_message,name="student_feedback_message",),
    path("staff/view/feedback/", admin_views.staff_feedback_message,name="staff_feedback_message",),
    ...
    path("hod/manage/", admin_views.manage_hod, name='manage_hod'),
    ...
    path("hod/edit/<int:hod_id>", admin_views.edit_hod, name='edit_hod'),  
    path("hod/delete/<int:hod_id>", admin_views.delete_hod, name='delete_hod'),
    ...
    path("student/edit/<int:student_id>",admin_views.edit_student, name='edit_student'),
    path("course/edit/<int:course_id>",admin_views.edit_course, name='edit_course'),
    path("subject/edit/<int:subject_id>",admin_views.edit_subject, name='edit_subject'),
    ...
    path("hod/home/", hod_views.hod_home, name='hod_home'),
    ...
    path("hod_notify_student", hod_views.hod_notify_student,name='hod_notify_student'),
    path("hod_notify_staff", hod_views.hod_notify_staff,name='hod_notify_staff'),
    path("hod_view_profile", hod_views.hod_view_profile,name='hod_view_profile'),
    ...
    path("attendance/view/", hod_views.hod_view_attendance,name="admin_view_attendance",),
    path("attendance/fetch/", hod_views.get_hod_attendance,name='get_admin_attendance'),
